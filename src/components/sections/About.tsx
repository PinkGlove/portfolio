        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-sm sm:text-lg text-gray-600 leading-relaxed">
              ...
              real-time monitoring systems with alerting—delivering solutions that automate <span className="text-blue-600 font-medium">250+ hours</span> of manual work annually and reduce fault detection time by <span className="text-blue-600 font-medium">99%</span>.
            </p>
